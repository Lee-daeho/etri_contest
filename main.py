...
def main():
    ...
    parser.add_argument('--weight_decay', '-decay', default=0, help='Weight Decay in training', type=float)
    ...
    parser.add_argument('--modal', '-m', default='wav', help='Type of data to train', type=str)
    ...
    for k in range(1, 6):
        ...
        wandb.init(
            ...
            name= f'wav2vec_fold{k}_pretrained'
        )
